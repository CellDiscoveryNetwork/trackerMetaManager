...
def generate_empty_metadata_entry_sheets(metadata_dfs, gc, credentials, folder_id, dataset_id, num_header_rows=1, tiers = {
    ...
    # configure sheet names in the "tiers" parameter
